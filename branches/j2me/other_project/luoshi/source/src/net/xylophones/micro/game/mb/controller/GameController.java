...
public class GameController implements BoardListener, StatusListener {
    ...
    public void boardEvent(int event) {
        if(event < BoardListener.EVENT_BLOCK_LANDED)
            Midlet.MIDLET.musicManager.start_fire_music();
        switch( event ) {
    ...
    private void setStoredHighScore(int score) { 
        ...
        //#endif
        Midlet.MIDLET.rsm.highscore = score;
        Midlet.MIDLET.rsmManager.saveRsm();
    }
    ...
    private int getStoredHighScore() {
        ...
        //#endif
        highScore =  Midlet.MIDLET.rsm.highscore;
        return highScore;
    }
