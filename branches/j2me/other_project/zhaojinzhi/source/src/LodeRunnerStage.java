...
class LodeRunnerStage
{
  ...
  public static final int[] SPRITE_WIDTH = { 24, 6 };
  /** Tile/sprite height in pixels */
  public static final int[] SPRITE_HEIGHT = { 22, 6 };
  ...
  public void paint(Graphics g)
  {
    ...
    fontMedium = Font.getFont(Font.FACE_SYSTEM, Font.STYLE_PLAIN, Font.
    SIZE_MEDIUM);
    g.setFont(fontMedium);
    int str_width = fontMedium.stringWidth(Locale.get("General.Exit"));
    int str_height = fontMedium.getHeight();
    g.setColor(0xffff00);
    g.drawString(Locale.get("General.Back"), canvas.gameWidth-str_width-5,
            canvas.gameHeight-str_height-2, Graphics.TOP | Graphics.LEFT);
  }
